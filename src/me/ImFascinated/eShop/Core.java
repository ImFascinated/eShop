...
import me.ImFascinated.eShop.Events.eShopEvent;
import me.ImFascinated.eShop.Utils.Config;
import me.ImFascinated.eShop.Utils.CoreUtils;
import me.ImFascinated.eShop.commands.eshop;
...
public class Core extends JavaPlugin {
    ...
    public void onEnable() {
    	instance = this;
    	this.getCommand("eshop").setExecutor(new eshop());
    	this.getServer().getPluginManager().registerEvents(new eShopEvent(), this);
    	setupYMLFiles();
    	setupEconomy();
        if (!setupEconomy() ) {
